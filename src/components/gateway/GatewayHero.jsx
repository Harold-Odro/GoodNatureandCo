...
export function GatewayHero() {
  ...
  return (
    <section className="relative min-h-svh flex items-center justify-center overflow-hidden">
      ...
      <svg aria-hidden="true" className="absolute top-8 left-8 sm:top-12 sm:left-12 w-16 h-16 sm:w-24 sm:h-24 text-sage-400/40" viewBox="0 0 100 100" fill="none">
      ...
      <svg aria-hidden="true" className="absolute top-8 right-8 sm:top-12 sm:right-12 w-16 h-16 sm:w-24 sm:h-24 text-sage-400/40 -scale-x-100" viewBox="0 0 100 100" fill="none">
        <path d="M10 90 Q10 50, 50 50 Q50 10, 90 10" stroke="currentColor" strokeWidth="1" fill="none"/>
        <circle cx="30" cy="70" r="4" fill="currentColor" opacity="0.5"/>
        <circle cx="50" cy="50" r="3" fill="currentColor" opacity="0.4"/>
        <circle cx="70" cy="30" r="4" fill="currentColor" opacity="0.5"/>
      ...
      <svg aria-hidden="true" className="absolute bottom-8 left-8 sm:bottom-12 sm:left-12 w-16 h-16 sm:w-24 sm:h-24 text-sage-400/40 -scale-y-100" viewBox="0 0 100 100" fill="none">
        <path d="M10 90 Q10 50, 50 50 Q50 10, 90 10" stroke="currentColor" strokeWidth="1" fill="none"/>
        <circle cx="30" cy="70" r="4" fill="currentColor" opacity="0.5"/>
        <circle cx="50" cy="50" r="3" fill="currentColor" opacity="0.4"/>
        <circle cx="70" cy="30" r="4" fill="currentColor" opacity="0.5"/>
      ...
      <svg aria-hidden="true" className="absolute bottom-8 right-8 sm:bottom-12 sm:right-12 w-16 h-16 sm:w-24 sm:h-24 text-sage-400/40 scale-x-[-1] scale-y-[-1]" viewBox="0 0 100 100" fill="none">
        <path d="M10 90 Q10 50, 50 50 Q50 10, 90 10" stroke="currentColor" strokeWidth="1" fill="none"/>
        <circle cx="30" cy="70" r="4" fill="currentColor" opacity="0.5"/>
        <circle cx="50" cy="50" r="3" fill="currentColor" opacity="0.4"/>
        <circle cx="70" cy="30" r="4" fill="currentColor" opacity="0.5"/>
      ...
      <div className="relative z-10 text-center px-6 py-12">
        ...
        <p ref={taglineRef} className={`mt-6 text-lg sm:text-xl md:text-2xl font-display italic text-charcoal-600 ${taglineClass}`}>
          {SITE_INFO.tagline}
        </p>
      </div>
      ...
      <div className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 animate-float z-10">
        <div className="flex flex-col items-center gap-2">
          <span className="text-charcoal-500 text-xs uppercase tracking-widest">Explore</span>
          <svg aria-hidden="true" className="w-5 h-5 text-charcoal-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
