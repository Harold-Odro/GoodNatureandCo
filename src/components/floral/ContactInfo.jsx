    ...
    <div className="space-y-8">
      <div>
        ...
        <div className="space-y-5">
          <div>
            <p className="text-sm font-display text-charcoal-500 mb-1">Phone</p>
            <a
          ...
          <div>
            <p className="text-sm font-display text-charcoal-500 mb-1">Email</p>
            <a
          ...
          <div>
            <p className="text-sm font-display text-charcoal-500 mb-1">Instagram</p>
            <a
      ...
      <div>
        <h4 className="text-lg font-display text-charcoal-800 mb-2">Service Area</h4>
        <p className="text-charcoal-700">{SITE_INFO.serviceArea}</p>
      </div>

      <div className="pt-6 border-t border-linen-300">
        <p className="text-sm text-charcoal-600 leading-relaxed italic">
